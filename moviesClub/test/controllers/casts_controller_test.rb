...
class CastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cast" do
    assert_difference('Cast.count') do
      post casts_url, params: { cast: { actor_id: @cast.actor_id, lunch_date: @cast.lunch_date, place: @cast.place } }
    end
  ...
  test "should update cast" do
    patch cast_url(@cast), params: { cast: { actor_id: @cast.actor_id, lunch_date: @cast.lunch_date, place: @cast.place } }
